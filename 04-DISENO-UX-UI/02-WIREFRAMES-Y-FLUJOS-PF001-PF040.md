...
| **004 Registro** | Formulario de 480 px por bloques: identidad, contacto, contraseña, consentimientos y anti-robot; lateral ilustrativo solo en escritorio. | Nombres, apellidos separados, correo, WhatsApp opcional, DNI claramente rotulado “Opcional”, contraseña/confirmación, checks legales, “Crear cuenta” y contacto por WhatsApp. | Fortaleza y requisitos en vivo, correo existente sin revelar de más, fallo de envío. El DNI vacío nunca muestra error ni bloqueo. Móvil: una columna y CTA al final. |
...
| **009 Mi perfil** | Encabezado, pestañas Datos y Seguridad; formulario en tarjeta de 720 px; bloque de datos congelados informativo. | Guardar nombres, apellidos, teléfono opcional y DNI opcional; cambiar contraseña. Correo de acceso solo lectura. | Cambios sin guardar, guardado, DNI vacío válido y distinción entre nombres usados por el certificado y DNI no utilizado para emitirlo. |
| **010 Gestión de usuarios** | Barra admin; título y CTA; filtros; tabla; panel lateral de detalle/creación. | Buscar por correo antes de crear; nombres y apellidos obligatorios, teléfono y DNI opcionales, y rol Alumno/Administrador; crear, reenviar instrucciones o deshabilitar. | DNI vacío válido; cuenta existente, CAMBIO_PENDIENTE, habilitada, último admin y auto-desactivación bloqueados. Mostrar otorgante del rol. |
...
| PF | Composición exacta | Controles y acción principal | Estados y adaptación |
|---|---|---|---|
| **029 Estado de certificación** | Encabezado de logro; lista valor/meta; promedio y nivel proyectado; nombres y apellidos del certificado; bloque temporal. | Confirmar nombres y apellidos; con espera cero “Generar certificado ahora” o “Seguir mejorando”. | PENDIENTE_REQUISITOS, PENDIENTE_DATOS solo por nombres o apellidos, PROGRAMADO, LISTO_PARA_EMITIR y emitido. El DNI no aparece como requisito. Modal final explica congelamiento. |
